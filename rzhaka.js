...
function detector() {
	...
	var res2=document.getElementById("res2");
	var bannr=document.getElementById("bnnr");
	var inBanner=document.getElementById("inBanner");
...
var t = product-o*10; 
	  if(result==product){
		console.log("Krasava"+result); 
	//bannr.style.borderColor="#008500";
	  bannr.style.backgroundColor="#d0ede3";
	  inBanner.innerHTML="Правильно!";
	  }
	  else {
	//bannr.style.borderColor="#A60000";
	  bannr.style.backgroundColor="#fc556b";
	  inBanner.innerHTML="Неправильно!"; 
	  }
